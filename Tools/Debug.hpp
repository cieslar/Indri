...
#include<string>
#include<cstdlib>
#define WARNING(info_string) 			\
{						\
	std::cerr<<"Warning: "<< info_string 	\
		 <<" File: "<<__FILE__		\
		 <<" Line: "<<__LINE__		\
		 <<std::endl; 			\
}

#define ERROR(info_string)			\
{						\
	std::cerr<<"Error: "<< info_string 	\
		 <<" File: "<<__FILE__		\
		 <<" Line: "<<__LINE__		\
		 <<std::endl; 			\
	exit(1);				\
...
//Simple argumet paraser. Taken from:
//https://stackoverflow.com/questions/865668/parse-command-line-arguments
...
//the fuck! dynamic array on stack bullshit. >:(
//changed to normal static array
//MC 01.02.16
